    ...
    <div className="w-full max-w-3xl mx-auto mt-8 mb-16">
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 via-blue-500/10 to-orange-500/10" />
          <motion.div
          ...
          <div className="relative flex items-center gap-2 flex-shrink-0">
            ...
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-500 rounded-full blur-lg opacity-50" />
              <div className="relative bg-gradient-to-br from-blue-500 to-blue-600 p-2 rounded-xl shadow-lg shadow-blue-500/20">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <motion.h2 
                className="text-sm sm:text-xl font-bold bg-gradient-to-r from-white via-blue-200 to-blue-200 bg-clip-text text-transparent"
          ...
          <motion.div
            ...
            className="relative flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1 rounded-full bg-gradient-to-r from-blue-500/10 to-blue-500/10 border border-blue-500/20 ml-2 sm:ml-4 flex-shrink-0"
          >
            <motion.div
