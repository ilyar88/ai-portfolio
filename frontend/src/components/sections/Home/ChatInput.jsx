      ...
      <AnimatePresence mode="wait">
        {isLoading ? (
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="flex-shrink-0 bg-gradient-to-r from-blue-500 to-blue-500 text-white p-3 rounded-lg transition-all duration-200 shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 hover:from-blue-600 hover:to-blue-600 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
          >
