...
export const ProjectsSection = () => {
  const { repos, loading, error } = useGithubRepos('ilyar88','Dockerized_Flask_Mongo_App_Project',6)
  ...
  return (
    ...
    >
      {repos.map((repo, index) => (
        ...
        >
          <div className="absolute inset-0 rounded-lg transform group-hover:scale-105 transition-transform" />
